package com.example.kin.menupicture.Login;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //iv = (ImageView) findViewById(R.id.logo_menu);
        //Picasso.with(iv.getContext()).load(R.drawable.ic_smart_logo).fit().centerCrop().into(iv);
